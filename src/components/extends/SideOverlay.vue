<template>
    <aside id="side-overlay">
        ...
        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 313px;"><div id="side-overlay-scroll" style="overflow: hidden; width: auto; height: 313px;">
            <!-- Side Header -->
            <div class="side-header side-content">
                ...
                <span>
                            <img class="img-avatar img-avatar32" src="/src/assets/img/avatars/avatar10.jpg" alt="">
                            ...
                            <div class="block pull-r-l">
                                ...
                                <div class="block-content block-content-full">
                                    ...
                                    <ul class="nav-users remove-margin-b">
                                        ...
                                        <li>
                                            <a href="base_pages_profile.html">
                                                <img class="img-avatar" src="/src/assets/img/avatars/avatar1.jpg" alt="">
                                        ...
                                        <li>
                                            <a href="base_pages_profile.html">
                                                <img class="img-avatar" src="/src/assets/img/avatars/avatar3.jpg" alt="">
            ...
            <!-- END Side Content -->
        </div><div class="slimScrollBar" style="background: rgb(0, 0, 0); width: 5px; position: absolute; top: 0px; opacity: 0.35; display: block; border-radius: 7px; z-index: 99; right: 2px; height: 319.304px;"></div><div class="slimScrollRail" style="width: 5px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 1; z-index: 90; right: 2px;"></div></div>
